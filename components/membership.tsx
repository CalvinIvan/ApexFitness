    ...
    >
      <div className="flex flex-col items-center">
        ...
        <div className="mt-5 flex flex-col flex-wrap items-center justify-center gap-5 sm:flex-row">
          <div>
            <Card className="h-[325px] max-w-[375px] rounded-lg bg-gradient-to-r from-rose-200 to-red-500/50 text-gray-600 transition hover:scale-105 sm:max-w-[400px]">
          ...
          <div>
            <Card className="h-[325px] max-w-[375px] rounded-lg bg-gradient-to-r from-rose-200 to-red-500/60 text-gray-700 transition hover:scale-105">
              <CardHeader className="flex gap-3">
                <div className="flex w-full flex-col items-center justify-center ">
                  <p className="text-md font-semibold">
          ...
          <div>
            <Card className="h-[325px] max-w-[375px] rounded-lg bg-gradient-to-r from-rose-400 to-red-500/80 text-gray-800 transition hover:scale-105">
              <CardHeader className="flex gap-3">
                <div className="flex w-full flex-col items-center justify-center ">
                  <p className="text-md font-semibold">
                    Pro
