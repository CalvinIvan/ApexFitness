  ...
  return (
    ...
    >
      <div className="w-[89%] m-auto max-w-[1400px] flex justify-between items-center">
        <a href="">
          <h1 className="text-3xl font-bold text-gray-700">APEX Fitness</h1>
        </a>

        <ul
          className={`md:flex items-center gap-8 md:static absolute text-gray-600  ${
            openMobileMenu
              ? "top-12 py-4 w-full bg-red-500/95 left-0 text-center space-y-10 text-white drop-shadow-lg z-20"
              : "hidden"
          }`}
        >
          <li>
        ...
        <div className="flex gap-4 text-white items-center ml-auto md:ml-0">
          <div className="bg-rose-500/95 p-1 rounded-full hover:translate-y-[-2px] transition-all">
