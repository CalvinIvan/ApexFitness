const Footer = () => {
  return (
    <footer className="footer bg-red-500/95 text-white relative">
              ...
              <form>
                <div className="flex flex-wrap mx-2 p-3 md:p-0">
                  ...
                  <div className="mx-auto md:w-1/3 px-2">
                    <button
                      type="submit"
                      className="w-full bg-rose-700 duration-500 hover:bg-rose-600 rounded-md py-2 px-4 text-white"
                    >
                      Subscribe
                    </button>
                  </div>
