      ...
      <div className="max-w-[1400px] w-[89%] m-auto grid  md:grid-cols-2 grid-cols-1 gap-10 items-center">
        ...
        <div className="relative w-full">
          <img
            ...
            alt=""
          />
          <div className="absolute bottom-2 md:bottom-10 lg:bottom-20 left-2 md:left-5 p-4 m-3 w-44 rounded-lg shadow-md bg-white text-center scale-75 md:scale-100">
            <span className="text-3xl font-bold mb-0 text-rose-500">10k+</span>
            <h6 className="text-sm text-slate-400 mt-1">Reviews</h6>
          </div>
          <div className="absolute right-[-25px] md:scale-100 scale-75 top-5 md:top-10 lg:top-10 md:right-0 lg:right-8 p-4 w-44 rounded-lg shadow-md bg-white m-3 text-center">
