...
const Info = () => {
  return (
    <section className="mt-10 ">
      <div
        className="w-[89%] m-auto max-w-[1400px] flex flex-col lg:flex-row gap-8 xl:gap-[180px] scroll-mt-[7rem]"
        id="about"
      >
        {/* LEFT SIDE */}
        <div className="grid grid-cols-1 flex-1 gap-[30px] md:grid-cols-2 xl:gap-y-[70px]">
          <div>
            <h1 className="font-bold md:text-[45px] md:leading-[52px] text-[35px] leading-[42px] mb-1 text-rose-500">
              25k+
            </h1>
            <p className="mb-3 font-bold text-gray-600">
              Daily Clients Serviced
            </p>
          ...
          <div>
            <h1 className="font-bold md:leading-[52px] text-[35px] leading-[42px] mb-1 text-rose-500">
              Over 125
            </h1>
        ...
        <div className="flex-1">
          <h1 className="text-[35px] leading-[44px] sm:text-[46px] sm:leading-[52px] font-extrabold mb-[30px] lg:mb-[53px] text-rose-400 drop-shadow-sm">
